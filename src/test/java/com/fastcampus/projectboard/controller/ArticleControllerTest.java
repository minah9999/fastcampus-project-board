...
class ArticleControllerTest {
    ...
    @Test
    void givenNoting_whenRequestingArticlePage_thenRedirectToLoginPage() throws Exception{
        //given
        Long articleId = 1L;
    ...
    @Test
    void givenNoting_whenRequesting_thenRedirectToLoginPage() throws Exception{
        //given
        Long articleId = 1L;
